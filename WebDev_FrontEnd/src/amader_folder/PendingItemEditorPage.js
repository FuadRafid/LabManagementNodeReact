...
import PendingItemEditorPost from "./PendingItemEditorPost";
...
class PendingItemEditorPage extends Component {
  state={
    namesListState:null
  };
  searchClicked=()=>{
    ...
    namesList = searchList.map(function(data){
      ...
      return (
        <PendingItemEditorPost itemId ={data.user_id} user_id={data.user_id}/>
      );
  ...
  componentDidMount()
  {
    ...
    axios.post('/getEditorPendingIds')
      .then((response) => {
...
export default PendingItemEditorPage;
